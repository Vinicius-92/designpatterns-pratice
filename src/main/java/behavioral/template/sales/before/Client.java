package behavioral.template.sales.before;

import java.util.Arrays;

import behavioral.template.sales.before.model.Buyer;
import behavioral.template.sales.before.model.Cart;
import behavioral.template.sales.before.model.Category;
import behavioral.template.sales.before.model.Product;
import behavioral.template.sales.before.service.BestOfferService;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		Product notebook = new Product("Notebook", 999.99d, Category.ELECTRONICS, 10d);
		...
		Product mouse = new Product("Mouse", 10d, Category.ELECTRONICS, 0.2d);
