package behavioral.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import behavioral.command.migration.commands.UserTableRoleColumn;
import behavioral.command.migration.commands.ProductTable;
import behavioral.command.migration.commands.UserTable;
