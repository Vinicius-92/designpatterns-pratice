...
import behavioral.memento.component.TextAreaWithMemory;
import behavioral.memento.component.TextAreaWithMemory.TextAreaMemento;
import behavioral.memento.memory.Caretaker;
import behavioral.memento.memory.Memento;
...
public class Client {
	public static void main(String[] args) {
		...
		save.addActionListener(e -> {
			caretaker.add((Memento) originator.save());
